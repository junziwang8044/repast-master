package com.aaa.repast.admin.project.system.shopinformation.shopinformation.domain;
...
public class ShopInformation extends BaseEntity
{
	...
	private MultipartFile businessLicensePic;
	/** 食品安全许可证图片链接 */
	...
	public MultipartFile getBusinessLicensePic() {
		return businessLicensePic;
	}

	public void setBusinessLicensePic(MultipartFile businessLicensePic) {
	...
	public String toString() {
		return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
				...
				.append("businessLicensePic", getBusinessLicensePic())
